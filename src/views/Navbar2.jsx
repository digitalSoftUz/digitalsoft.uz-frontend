  ...
  return (
    <DS.Consumer>
      {(x)=>{
        return(
          <div 
            className={x.scroll > 300 ? "navbar__fixed nav__scrolled" : "navbar__fixed"}
            id={burger ? "" : "blur__off"}
          >
            <div className={x.scroll > 200 ? "navbar container" : "navbar"}>
              ...
              <nav className={burger ? 'nav' : 'nav nav__show'}>
                ...
                <Dropdown overlay={menu2} placement="bottom" arrow> */}
                  <a href='/' type='link'>Raqamlashtirish</a>
                {/* </Dropdown>
                <Dropdown overlay={menu3} placement="bottom" arrow> */}
                  <a href='/' type='link'>Ish o’rinlari</a>
                {/* </Dropdown>
                <Dropdown overlay={menu4} placement="bottom" arrow> */}
                  <a href='/' type='link'>Biz haqimizda</a>
                {/* </Dropdown> */}
